...
class VendingMachine:
    ...
    def __init__(self,product,price):
        ...
        self.deposited=0
    def vend(self):
        amt_left_to_pay=self.price-self.deposited
        if self.stock==0:
            return 'Machine is out of stock.'
        elif amt_left_to_pay>0:
            return 'You must deposit $'+str(amt_left_to_pay)+' more.'
        elif amt_left_to_pay==0:
            self.deposited=0
            self.stock-=1
            ...
            self.deposited=0
            self.stock-=1
            return 'Here is your '+self.product+' and $'+str(-amt_left_to_pay)+' change.'
    ...
    def deposit(self,amt):
        ...
        self.deposited+=amt
        return 'Current balance: $'+str(self.deposited)
...
def generate_paths(t, x):
    ...
    if t.label==x:
        yield lst
    for b in t.branches:
        for paths in generate_paths(b, x):
            nlst=lst+paths
            yield nlst
